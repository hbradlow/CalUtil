...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusTime'
        db.create_table('api_bustime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('stop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.BusStop'])),
            ('pub_date', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('api', ['BusTime'])

        # Adding field 'BusStop.has_non_realtime'
        db.add_column('api_busstop', 'has_non_realtime',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BusTime'
        db.delete_table('api_bustime')

        # Deleting field 'BusStop.has_non_realtime'
        db.delete_column('api_busstop', 'has_non_realtime')
