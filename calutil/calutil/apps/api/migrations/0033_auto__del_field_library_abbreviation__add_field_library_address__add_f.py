...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Library.abbreviation'
        db.delete_column('api_library', 'abbreviation')

        # Adding field 'Library.address'
        db.add_column('api_library', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)

        # Adding field 'Library.link'
        db.add_column('api_library', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Library.image_url'
        db.add_column('api_library', 'image_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'Library.phone'
        db.add_column('api_library', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Library.abbreviation'
        db.add_column('api_library', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)

        # Deleting field 'Library.address'
        db.delete_column('api_library', 'address')

        # Deleting field 'Library.link'
        db.delete_column('api_library', 'link')

        # Deleting field 'Library.image_url'
        db.delete_column('api_library', 'image_url')

        # Deleting field 'Library.phone'
        db.delete_column('api_library', 'phone')
    ...
    models = {
        ...
        'api.campusbuilding': {
            'Meta': {'object_name': 'CampusBuilding'},
            'abbreviation': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            'built': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latitude': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'longitude': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
        ...
        'api.rsfroom': {
            ...
            'update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        },
        'api.section': {
