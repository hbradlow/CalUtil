...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.longitude'
        db.alter_column('api_building', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Building.latitude'
        db.alter_column('api_building', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Building.longitude'
        raise RuntimeError("Cannot reverse this migration. 'Building.longitude' and its values cannot be restored.")

        # Changing field 'Building.latitude'
        db.alter_column('api_building', 'latitude', self.gf('django.db.models.fields.FloatField')(default=0))
