...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampusBuilding'
        db.create_table('api_campusbuilding', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('built', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal('api', ['CampusBuilding'])


    def backwards(self, orm):
        # Deleting model 'CampusBuilding'
        db.delete_table('api_campusbuilding')
