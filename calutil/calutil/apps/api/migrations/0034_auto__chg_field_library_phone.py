...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Library.phone'
        db.alter_column('api_library', 'phone', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'Library.phone'
        db.alter_column('api_library', 'phone', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'api.library': {
            ...
            'phone': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300'})
        },
        'api.location': {
