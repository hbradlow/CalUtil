...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.timespan_string'
        db.add_column('api_location', 'timespan_string',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.timespan_string'
        db.delete_column('api_location', 'timespan_string')
