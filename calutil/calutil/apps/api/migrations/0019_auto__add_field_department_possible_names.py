...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Department.possible_names'
        db.add_column('api_department', 'possible_names',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Department.possible_names'
        db.delete_column('api_department', 'possible_names')
