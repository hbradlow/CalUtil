...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_department', (
        ...
        db.send_create_signal('api', ['Department'])

        # Adding field 'Course.department'
        db.add_column('api_course', 'department',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Department'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Department'
        db.delete_table('api_department')

        # Deleting field 'Course.department'
        db.delete_column('api_course', 'department_id')
