...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('api', ['Building'])

        # Adding field 'Course.building'
        db.add_column('api_course', 'building',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Building'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Building'
        db.delete_table('api_building')

        # Deleting field 'Course.building'
        db.delete_column('api_course', 'building_id')
