...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Section.units'
        db.delete_column('api_section', 'units')

        # Adding field 'Section.section'
        db.add_column('api_section', 'section',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True),
                      keep_default=False)

        # Adding field 'Section.course'
        db.add_column('api_section', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='sections', to=orm['api.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Section.units'
        db.add_column('api_section', 'units',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True),
                      keep_default=False)

        # Deleting field 'Section.section'
        db.delete_column('api_section', 'section')

        # Deleting field 'Section.course'
        db.delete_column('api_section', 'course_id')
    ...
    models = {
        ...
        'api.course': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'LEC'", 'max_length': '20', 'null': 'True'}),
        ...
        'api.section': {
            ...
            'section': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'null': 'True'}),
            'time': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'DIS'", 'max_length': '20', 'null': 'True'}),
            'waitlist': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '10', 'null': 'True'})
        },
        'api.timespan': {
