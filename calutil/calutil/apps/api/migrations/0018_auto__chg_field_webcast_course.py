...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Webcast.course'
        db.alter_column('api_webcast', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Course'], null=True))

    def backwards(self, orm):

        # Changing field 'Webcast.course'
        db.alter_column('api_webcast', 'course_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['api.Course']))
