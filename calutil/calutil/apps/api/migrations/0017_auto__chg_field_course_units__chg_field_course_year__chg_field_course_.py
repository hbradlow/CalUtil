...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('api_course', 'units', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Course.year'
        db.alter_column('api_course', 'year', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Course.section'
        db.alter_column('api_course', 'section', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Course.type'
        db.alter_column('api_course', 'type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Course.ccn'
        db.alter_column('api_course', 'ccn', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Section.exam_group'
        db.alter_column('api_section', 'exam_group', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Section.section'
        db.alter_column('api_section', 'section', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Section.ccn'
        db.alter_column('api_section', 'ccn', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Section.type'
        db.alter_column('api_section', 'type', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Course.units'
        db.alter_column('api_course', 'units', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.year'
        db.alter_column('api_course', 'year', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.section'
        db.alter_column('api_course', 'section', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.type'
        db.alter_column('api_course', 'type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Course.ccn'
        db.alter_column('api_course', 'ccn', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.exam_group'
        db.alter_column('api_section', 'exam_group', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.section'
        db.alter_column('api_section', 'section', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.ccn'
        db.alter_column('api_section', 'ccn', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Section.type'
        db.alter_column('api_section', 'type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
