...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RSFRoom.last_update'
        db.alter_column('api_rsfroom', 'last_update', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'RSFRoom.last_update'
        db.alter_column('api_rsfroom', 'last_update', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 14, 0, 0)))
