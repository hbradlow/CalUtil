...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.abbreviation'
        db.alter_column('api_course', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Course.abbreviation'
        db.alter_column('api_course', 'abbreviation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
