...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.exam_group'
        db.alter_column('api_course', 'exam_group', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Course.exam_group'
        db.alter_column('api_course', 'exam_group', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
