...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Webcast.course'
        db.add_column('api_webcast', 'course',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['api.Course']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Webcast.course'
        db.delete_column('api_webcast', 'course_id')
