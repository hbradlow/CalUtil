...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Building.display_name'
        db.add_column('api_building', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Building.display_name'
        db.delete_column('api_building', 'display_name')
