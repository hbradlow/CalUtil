...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.year'
        db.alter_column('api_building', 'year', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Building.year'
        db.alter_column('api_building', 'year', self.gf('django.db.models.fields.IntegerField')(default=0))
