...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Building.description'
        db.add_column('api_building', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'Building.year'
        db.add_column('api_building', 'year',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Building.description'
        db.delete_column('api_building', 'description')

        # Deleting field 'Building.year'
        db.delete_column('api_building', 'year')
