...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeSpan.type'
        db.alter_column('api_timespan', 'type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Adding M2M table for field timespans on 'CalOneCardLocation'
        db.create_table('api_calonecardlocation_timespans', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('calonecardlocation', models.ForeignKey(orm['api.calonecardlocation'], null=False)),
            ('timespan', models.ForeignKey(orm['api.timespan'], null=False))
        ))
        db.create_unique('api_calonecardlocation_timespans', ['calonecardlocation_id', 'timespan_id'])


    def backwards(self, orm):

        # Changing field 'TimeSpan.type'
        db.alter_column('api_timespan', 'type', self.gf('django.db.models.fields.CharField')(default='breakfast', max_length=50))
        # Removing M2M table for field timespans on 'CalOneCardLocation'
        db.delete_table('api_calonecardlocation_timespans')
