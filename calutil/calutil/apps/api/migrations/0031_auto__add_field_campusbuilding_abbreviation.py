...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampusBuilding.abbreviation'
        db.add_column('api_campusbuilding', 'abbreviation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CampusBuilding.abbreviation'
        db.delete_column('api_campusbuilding', 'abbreviation')
