...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RSFRoom.last_update'
        db.delete_column('api_rsfroom', 'last_update')

        # Adding field 'RSFRoom.update'
        db.add_column('api_rsfroom', 'update',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RSFRoom.last_update'
        db.add_column('api_rsfroom', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'RSFRoom.update'
        db.delete_column('api_rsfroom', 'update')
